...
public class HiZOcclusion : MonoBehaviour {
    ...
    // Compute Shader.
    [Tooltip("The compute shader to use to generate the Hi-Z occlusion texture.")]
    ...
    void OnEnable() {
        ...
        Shader.SetGlobalVector("_CameraDimensions", new Vector4(Camera.main.pixelWidth, Camera.main.pixelHeight, 0, 0));
    ...
    void Update() {
        ...
        Shader.SetGlobalVector("_ZBufferParams_Custom", new Vector4(
            -1.0f + Camera.main.farClipPlane / Camera.main.nearClipPlane,
            1.0f,
            -1.0f / Camera.main.farClipPlane + 1.0f / Camera.main.nearClipPlane,
            1.0f / Camera.main.farClipPlane
        ));
    ...
    private void OnGUI() {
        ...
        // Draw specific mip level texture
            ...
            // Read pixels from the mip level
